# -*- coding: utf-8 -*-
"""
Created on Tue Dec 15 15:40:32 2015
...
pathname = os.environ['HOME'] + '/Dropbox/nemes/dados/ADCP_Reef_Reserva/20150729/ADCP_no_REEF/'

#carrega arquivo .sen
sen = np.loadtxt(pathname + 'ADCP_REEF_29-07-2015.sen')
