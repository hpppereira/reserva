...
#pathname = os.environ['HOME'] + '/Dropbox/reserva/dados/ADCP_Reef_Reserva/20151221_2.2_11s/adcp/'

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20151221/adcp/'
#dd = pd.read_table(pathname + 'ADCP_REEF_21_12_2015.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20150720_1.65_8s/'
#dd = pd.read_table(pathname + 'ADCP_20_07_2015.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20131121e22/'
#dd = pd.read_table(pathname + 'DADOS_21a22_11_2013.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20150701/'
#dd = pd.read_table(pathname + 'ADCP_REEF_01-07-2015.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20150729/'
#dd = pd.read_table(pathname + 'ADCP_REEF_29-07-2015.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20150805/ADCP/'
#dd = pd.read_table(pathname + 'ADCP_05_08_2015.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20150910/'
#dd = pd.read_table(pathname + 'ADCP_REEF_10_09_2015.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20150916/ADCP_16_09_15/'
#dd = pd.read_table(pathname + 'ADCP_REEF_16_09_2015.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20151214/ADCP/'
#dd = pd.read_table(pathname + 'ADCP_REEF_14_12_2015.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20160113/ADCP/'
#dd = pd.read_table(pathname + 'ADCP_REEF_13_01_2016.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20160128/ADCP/'
#dd = pd.read_table(pathname + 'ADCP_REEF_28_01_2016.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])

#pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20151111/ADCP/'
#dd = pd.read_table(pathname + 'ADCP_REEF_11_11_2015.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])


pathname = 'C:/Users/douglas.MENTAWAII/Dropbox/nemes/dados/ADCP_Reef_Reserva/20151014/ADCP 14,10,15/'
dd = pd.read_table(pathname + 'ADCP_REEF_14_10_2015.wad',sep='\s*',header=None, usecols=(0,2,5,6,7), names=['ens','pr','vx','vy','vz'])
...
#numero de amostras
a=np.unique(dd.ens)[:-3]

#hora de coleta
#hora = ['0745','0819','0853','0927','1001','1035','1109','1143','1218','1252','1326','1400','1434','1508','1542','1617','1651','1725','1759','1833','1907'][:-3]
...
hora = ['0735','0750','0805','0820','0835','0850','0905','0920','0935','0950','1005','1020','1035','1050','1105','1120','1135','1150','1205','1220','1235','1250','1305','1220','1235','1250','1305','1320','1335','1350','1405','1420','1435','1450','1505','1520','1535','1550','1605','1620','1635','1650','1705','1720','1735','1750','1805','1820'][:-3] #46
...
cont = 0
for i in range(1,len(a)-2,1): #range (início da matriz do espectro, o tamanho dela, de 1 em 1)
    cont += 0.2
    pl.subplot(1,4,1)
    pl.plot(epr[hora[i]][:,0],cont+epr[hora[i]][:,1])
    pl.xlim(0,0.2)#, pl.ylim(0,12)
