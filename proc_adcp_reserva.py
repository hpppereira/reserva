...
def plot_time_series():
	...
	ax1.plot(df.Pressure - df.Pressure.mean())
	ax1.plot(df.Depth - df.Depth.mean())
...
if __name__ == "__main__":
    ...
    df = pd.read_csv('/home/hp/Dropbox/reserva/data/ADCP_Reef_Reserva/20160128/ADCP_REEF_28_01_2016.wad',
                     sep='\s+', usecols=[2,5,6,7], header=None, names=['pres','vx','vy','vz'])
