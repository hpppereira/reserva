...
function [f,an,anx,any,a1,b1,diraz,dirm,dirtp,fp,tp,hm0]=onda_freq(dt,h,eta,etax,etay)
...
diraz=diraz-180;% tinha -180

diraz=diraz-23.1; %correção magnética da RESERVA
